...
if print_feature_selection:
    ...
    clf_LgR = LogisticRegression(random_state=0) ## Sensitive to feature scaling
    tester.test_classifier(clf_LgR, data_cleaned, feat_default) ## print result
    
    clf_RdF = RandomForestClassifier(n_estimators=40, random_state=0)
    ...
    tester.test_classifier(clf_SVC, data_cleaned, feat_default) ## print result
...
if print_feature_selection:
    ...
    clf_LgR = LogisticRegression(random_state=0) ## Sensitive to feature scaling
    tester.test_classifier(clf_LgR, data_cleaned, feat_default_1) ## print result
    
    clf_RdF = RandomForestClassifier(n_estimators = 40, random_state=0)
    tester.test_classifier(clf_RdF, data_cleaned, feat_default_1) ## print result
    
    clf_SVC = SVC(kernel='linear', max_iter = 500,random_state=0) ## Sensitive to feature scaling
    tester.test_classifier(clf_SVC, data_cleaned, feat_default_1) ## print result
    print "\n"
...
if print_feature_selection:
    ...
    clf_LgR = LogisticRegression(random_state=0) ## Sensitive to feature scaling
    tester.test_classifier(clf_LgR, data_cleaned, feat_new) ## print result
    ...
    clf_SVC = SVC(kernel='linear', max_iter = 500,random_state=0) ## Sensitive to feature scaling
    tester.test_classifier(clf_SVC, data_cleaned, feat_new) ## print result
